      ...
      <div class="settings-section">
        ...
        <div class="setting-item">
          <div class="setting-label">
            ...
            <div class="setting-desc">Your public profile name</div>
          </div>
          <input type="text" class="input-field" placeholder="Your name" value="">
        </div>
        <div class="setting-item">
          <div class="setting-label">
            <div class="setting-name">Email Address</div>
            <div class="setting-desc">Your email for notifications</div>
          </div>
          <input type="email" class="input-field" placeholder="your@email.com" value="">
        </div>
